...
<p>
  <pre class="brush:js">View Some todo lists:</p>
...
<p>
  ...
  {{/users}}</pre>
  Mustache will take the &#8216;<em>users</em>&#8216; key of the data we pass to the view and iterate through it. From there I build a list of links to view the todo lists of each user. For now I just created a dummy user with the name james.
</p>



<p>
  <strong>Connecting the dispatcher to the controller</strong>
</p>
...
var fs                      = require('fs');
var url                     = require('url');
var controller            = require('./controller');</p>
